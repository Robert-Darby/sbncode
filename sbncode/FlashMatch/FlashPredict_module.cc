...
FlashPredict::FlashPredict(fhicl::ParameterSet const& p)
  ...
  , fRM(loadMetrics(p.get<std::string>("InputFileName"), p.get<std::string>("InputSearchPath")))
...
void FlashPredict::read_directory(const std::string& name, std::vector<std::string>& v)
{
